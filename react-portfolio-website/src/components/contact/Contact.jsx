      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>pete.pattapee@gmail.com</h5>
            <a href="mailto:pete.pattapee@gmail.com" target="_blank">
              Send a message
            </a>
          </article>
          <article className="contact__option">
            ...
            <a href="https://m.me/Divisition" target="_blank">
              Send a message
            </a>
          </article>
          <article className="contact__option">
            ...
            <h4>Line</h4>
            <h5>pete.peach</h5>
            <a href="https://line.me/ti/p/-PId1ubmO3" target="_blank">
              Send a message
            </a>
          </article>
        </div>
